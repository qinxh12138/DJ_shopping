...
#     nav_id = models.AutoField(verbose_name='导航ID', primary_key=True)
#     nav_name = models.CharField(verbose_name='导航名称', max_length=64)
#
#     class Meta:
#         db_table = 'navigation'
#         verbose_name = u'导航'
...
#     sub_title = models.CharField(verbose_name='商品信息', max_length=255)
...
#     cate = models.ForeignKey(Category, models.DO_NOTHING)
#     create_date = models.DateTimeField(verbose_name='创建时间', blank=True, null=True)
#
#     class Meta:
#         db_table = 'shop'
#         verbose_name = u'商品'
